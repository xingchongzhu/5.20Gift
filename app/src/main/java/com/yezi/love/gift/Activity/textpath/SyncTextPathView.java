...
import com.yezi.love.gift.Activity.textpath.painter.SyncPathPainter;
...
public class SyncTextPathView extends TextPathView {
    ...
    public SyncTextPathView(Context context, String mText, int mTextSize, int mDuration) {
        super(context);
        initData( mText,  mTextSize,  mDuration);
        init();
    }
    ...
    public void initData( String mText, int mTextSize, int mDuration){
        this.mText = mText;
